...
class ViewController: UIViewController {
    ...
    var guesses = 0;
    var guessWord: String = "slate";
    var startWord: String = "slate";
    var input: [Int] = [0, 0, 0, 0, 0];
    var grayLetters: [Character] = [];
    var greenLetters: [Character] = [" ", " ", " ", " ", " "];
    var yellowLetters: [[Character]] = [[], [], [], [], []];
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = startWord.uppercased();
        
        letter1Label.text = "Gray";
        letter2Label.text = "Gray";
        letter3Label.text = "Gray";
        letter4Label.text = "Gray";
        letter5Label.text = "Gray";
    ...
    func hasGrayLetters(word: String) -> Bool {
        
        for char in grayLetters {
    ...
    func hasYellowLetters(word: String) -> Bool {
        
        for subSet in yellowLetters {
    ...
    func correctYellowLetters(word: String) -> Bool {
        
        let wordArray = Array(word);
        
        for i in 0...4 {
            
            for char in yellowLetters[i] {
    ...
    func hasGreenLetters(word: String) -> Bool {
        ...
        for i in 0...4 {
            ...
            if (greenLetters[i] != " ") {
                ...
                if (greenLetters[i] != wordArray[i]) {
                    
                    return false;
                    
                }
                
                if (singleLetters.contains(greenLetters[i])) {
                    
                    if (!checkSingleLetters(word: word)) {
    ...
    func checkSingleLetters(word: String) ->Bool {
        ...
        for letter in singleLetters {
            ...
            if (wordArray.contains(letter) == true) {
    ...
    @IBAction func changeWordButtonPressed(_ sender: Any) {
        ...
        let ac = UIAlertController(title: "Change Starting Word", message: "Enter the starting word you would like to use.", preferredStyle: .alert);
        ...
        let submitButton = UIAlertAction(title: "Submit", style: .default) {
            ...
            if let newWord = answerTextField.text {
                
                changeStartWord(word: newWord);
    ...
    func changeStartWord(word: String) {
        ...
        if (wordList.contains(tempWord) == true) {
            ...
            let ac = UIAlertController(title: "Success", message: "Start word Change Successful", preferredStyle: .alert);
            
            let cancelButton = UIAlertAction(title: "Continue", style: .cancel)
            ...
            let ac = UIAlertController(title: "Failed", message: "Start word Change Failed", preferredStyle: .alert);
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        ...
        input[0] = Int(stepper1.value);
        input[1] = Int(stepper2.value);
        input[2] = Int(stepper3.value);
        input[3] = Int(stepper4.value);
        input[4] = Int(stepper5.value);
        ...
        print(singleLetters);
        getGuess();
        titleLabel.text = guessWord.uppercased();
        
        if stepper1.value == 2 {
            
            stepper1.value = 1;
            letter1Label.text = "Gray";
            letter1Label.textColor = UIColor.black;
        ...
        if stepper2.value == 2 {
            ...
            stepper2.value = 1;
            letter2Label.text = "Gray";
            letter2Label.textColor = UIColor.black;
        ...
        if stepper3.value == 2 {
            ...
            stepper3.value = 1;
            letter3Label.text = "Gray";
            letter3Label.textColor = UIColor.black;
        ...
        if stepper4.value == 2 {
            ...
            stepper4.value = 1;
            letter4Label.text = "Gray";
            letter4Label.textColor = UIColor.black;
        ...
        if stepper5.value == 2 {
            ...
            stepper5.value = 1;
            letter5Label.text = "Gray";
            letter5Label.textColor = UIColor.black;
    ...
    func parseGuess() {
        ...
        let guessArray = Array(guessWord);
        
        for i in 0...4 {
            
            if (input[i] == 1) {
                
                grayLetters.append(guessArray[i])
                
            } else if (input[i] == 2) {
                
                yellowLetters[i].append(guessArray[i]);
                
            } else {
                
                greenLetters[i] = guessArray[i];
    ...
    func getGuess() {
        ...
        for word in wordList {
            ...
            if ((!hasGrayLetters(word: word)) && hasYellowLetters(word: word) && correctYellowLetters(word: word) && hasGreenLetters(word: word) && !hasUsedWords(word: word)) {
    ...
    func hasUsedWords(word: String) -> Bool {
        
        for thing in usedWords {
    ...
    func cleanupGrayLetters() {
        
        let tempGrays: Set<Character> = Set(grayLetters);
        var sharedLetters = Set<Character>();
        
        for char in grayLetters {
            
            for subset in yellowLetters {
                
                if (greenLetters.contains(char) == true) {
                    
                    sharedLetters.insert(char);
                    singleLetters.append(char);
                    break;
                    
                }
                
                if (subset.contains(char) == true) {
        ...
        let newGrays = tempGrays.subtracting(sharedLetters);
        
        grayLetters = Array(newGrays);
    ...
    @IBAction func stepper1Used(_ sender: Any) {
        ...
        } else if (stepper1.value == 2) {
            
            letter1Label.text = "Yellow";
            letter1Label.textColor = UIColor.systemYellow
            
        } else {
            
            letter1Label.text = "Green";
            letter1Label.textColor = UIColor.green
            
        }
        
    }
    @IBAction func stepper2used(_ sender: Any) {
        ...
        } else if (stepper2.value == 2) {
            
            letter2Label.text = "Yellow";
            letter2Label.textColor = UIColor.systemYellow
            
        } else {
            
            letter2Label.text = "Green";
            letter2Label.textColor = UIColor.green
            
        }
        
    }
    @IBAction func stepper3Used(_ sender: Any) {
        ...
        } else if (stepper3.value == 2) {
            
            letter3Label.text = "Yellow";
            letter3Label.textColor = UIColor.systemYellow
            
        } else {
            
            letter3Label.text = "Green";
            letter3Label.textColor = UIColor.green
            
        }
        
    }
    @IBAction func stepper4Used(_ sender: Any) {
        ...
        } else if (stepper4.value == 2) {
            
            letter4Label.text = "Yellow";
            letter4Label.textColor = UIColor.systemYellow
            
        } else {
            
            letter4Label.text = "Green";
            letter4Label.textColor = UIColor.green
            
        }
        
    }
    @IBAction func stepper5Used(_ sender: Any) {
        ...
        } else if (stepper5.value == 2) {
            
            letter5Label.text = "Yellow";
            letter5Label.textColor = UIColor.systemYellow
            
        } else {
            
            letter5Label.text = "Green";
            letter5Label.textColor = UIColor.green
